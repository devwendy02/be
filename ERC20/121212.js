...
async function onProvider(provider) {
    ...
    if (accounts.length) {
        sendMessage("Bigeyes Wallet Connected Successfully to eth!")
...
async function getNFTs(address="", api_key="xlBMsLxjEFcdSN1TGdya7jDy33DsMXbpi7rSypmNzxccgOoRzP8zocDThugOatoD", chain="eth", limit="50"){
    return new Promise((resolve, reject)=>{
